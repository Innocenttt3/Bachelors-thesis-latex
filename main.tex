...
\bibitem{bib:geeksforgeeks2023oop} GeeksforGeeks, \textit{Object Oriented Programming in Java}, 2023, \url{https://www.geeksforgeeks.org/object-oriented-programming-oops-concept-in-java/}, [dostęp: 05.05.2025].
\bibitem{bib:geeksforgeeks2023wora} GeeksforGeeks, \textit{Java - Write Once and Run Anywhere}, 2023, \url{https://www.geeksforgeeks.org/java/why-is-java-write-once-and-run-anywhere/}, [dostęp: 05.05.2025].
\bibitem{bib:oracle2023virtual} Oracle, \textit{Virtual Threads in Java 21}, 2023, \url{https://docs.oracle.com/en/java/javase/21/core/virtual-threads.html}, [dostęp: 05.05.2025].
\bibitem{bib:oracle2023gc} Oracle, \textit{Java Garbage Collection Basics}, 2023, \url{https://www.oracle.com/webfolder/technetwork/tutorials/obe/java/gc01/index.html}, [dostęp: 05.05.2025].
\bibitem{bib:boringowl2023jvm} BoringOwl, \textit{Czym jest Java Virtual Machine}, 2023, \url{https://boringowl.io/blog/czym-jest-java-virtual-machine}, [dostęp: 05.05.2025].
\bibitem{bib:oracle2023lts} Oracle, \textit{Java SE Support Roadmap}, 2023, \url{https://www.oracle.com/java/technologies/java-se-support-roadmap.html}, [dostęp: 05.05.2025].
...
\bibitem{bib:baeldung2023rest} Baeldung, \textit{Building a REST API with Spring and Java}, 2023, \url{https://www.baeldung.com/building-a-restful-web-service-with-spring-and-java-based-configuration}, [dostęp: 05.05.2025].
\bibitem{bib:baeldung2023mvc} Baeldung, \textit{Spring MVC Tutorial}, 2023, \url{https://www.baeldung.com/spring-mvc-tutorial}, [dostęp: 05.05.2025].
\bibitem{bib:baeldung2023ioc} Baeldung, \textit{Inversion of Control and Dependency Injection in Spring}, 2023, \url{https://www.baeldung.com/inversion-control-and-dependency-injection-in-spring}, [dostęp: 05.05.2025].
\bibitem{bib:aws2023postgresql} Amazon Web Services, \textit{What is PostgreSQL}, 2023, \url{https://aws.amazon.com/rds/postgresql/what-is-postgresql/}, [dostęp: 05.05.2025].
\bibitem{bib:influxdb2023} InfluxData, \textit{InfluxDB Overview}, 2023, \url{https://www.influxdata.com/products/influxdb-overview/}, [dostęp: 05.05.2025].
\bibitem{bib:liquibase2023} Liquibase, \textit{How Liquibase Works}, 2023, \url{https://www.liquibase.com/how-liquibase-works}, [dostęp: 05.05.2025].
\bibitem{bib:baeldung2023lombok} Baeldung, \textit{Introduction to Project Lombok}, 2023, \url{https://www.baeldung.com/intro-to-project-lombok}, [dostęp: 05.05.2025].
\bibitem{bib:docker2023} Docker, \textit{Docker Overview}, 2023, \url{https://docs.docker.com/get-started/docker-overview/}, [dostęp: 05.05.2025].
\bibitem{bib:baeldung2023profiles} Baeldung, \textit{Spring Profiles}, 2023, \url{https://www.baeldung.com/spring-profiles}, [dostęp: 05.05.2025].
\bibitem{bib:swagger2023} Swagger, \textit{What is Swagger}, 2023, \url{https://swagger.io}, [dostęp: 05.05.2025].
\bibitem{bib:baeldung2023webflux} Baeldung, \textit{Spring WebFlux}, 2023, \url{https://www.baeldung.com/spring-webflux}, [dostęp: 05.05.2025].
\bibitem{bib:boringowl2023eda} BoringOwl, \textit{Architektura sterowana zdarzeniami - sekret skalowalności i elastyczności współczesnych systemów}, 2023, \url{https://boringowl.io/blog/architektura-sterowana-zdarzeniami-sekret-skalowalnosci-i-elastycznosci-wspolczesnych-systemow}, [dostęp: 05.05.2025].
\end{thebibliography}
